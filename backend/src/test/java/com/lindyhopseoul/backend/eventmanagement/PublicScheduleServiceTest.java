...
class PublicScheduleServiceTest {
    ...
    void findOpenSchedulesReturnsPublishedLessonsWithActualDescriptions() {
        ...
        assertThat(schedules.get(0).roleSelectionEnabled()).isFalse();
    }
    ...
    void findOpenSchedulesIncludesRoleSelectionSettingFromLesson() {
        ...
        assertThat(schedules).hasSize(1);
        assertThat(schedules.get(0).roleSelectionEnabled()).isTrue();
    }
    ...
    private Lesson lesson(LessonStatus status, String title, String description) {
        return lesson(status, title, description, false);
    }

    private Lesson lesson(LessonStatus status, String title, String description, boolean roleSelectionEnabled) {
        return lesson(
                status,
                LessonType.LEVEL1,
                LocalTime.of(14, 0),
    ...
    private Lesson lesson(
        ...
        return lesson(status, lessonType, startTime, endTime, displayOrder, title, description, false);
    }
